...
export const demoVoIPData: SIAPGURUData = {
  inputs: {
    ...
    nipGuru: "19851215 201101 1 002",
    namaKaprog: "Drs. Bambang Wijonarko, M.T.",
    nipKaprog: "19730418 200003 1 005",
    namaKepsek: "M. Heru Santoso, M.Pd.",
    nipKepsek: "19690824 199512 1 001",
