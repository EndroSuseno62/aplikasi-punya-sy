        ...
        {viewStyle === "interactive" ? (
          ...
          <div className="max-w-4xl mx-auto bg-white p-12 border border-slate-300 shadow-lg min-h-[11in] text-black">
            <div ref={printAreaRef} id="official-rpp-print-area" className="rpp-word-document font-serif" style={{ fontFamily: '"Times New Roman", Times, serif', fontSize: "12pt", lineHeight: "1.2 text-black" }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "15px" }} className="no-border-table">
                <tbody>
                  ...
                  <tr style={{ fontSize: "11pt" }}>
                    ...
                    <td>:</td>
                    <td>{inputs.namaGuru}{inputs.nipGuru ? ` (NIP. ${inputs.nipGuru})` : ""}</td>
              ...
              {/* Tanda Tangan Halaman Pengesahan (Borderless Table) - Segitiga Terbalik */}
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", border: "none" }} className="signature-table">
                  <tbody>
                    <tr style={{ border: "none" }}>
                      <td style={{ width: "50%", border: "none", padding: "0 10px 30px 0", fontSize: "11pt", verticalAlign: "top", textAlign: "left" }}>
                        Ketua Kompetensi Keahlian,
                        <br /><br /><br /><br /><br />
                        <span style={{ textDecoration: "underline", fontWeight: "bold" }}>{inputs.namaKaprog || "__________________________"}</span><br />
                        NIP. {inputs.nipKaprog || "__________________________"}
                      </td>
                      <td style={{ width: "50%", border: "none", padding: "0 0 30px 10px", fontSize: "11pt", verticalAlign: "top", textAlign: "right" }}>
                        Tegal, 28 Juni 2026<br />
                        Guru Mata Pelajaran,
                        <br /><br /><br /><br /><br />
                        <span style={{ textDecoration: "underline", fontWeight: "bold" }}>{inputs.namaGuru || "__________________________"}</span><br />
                        NIP. {inputs.nipGuru || "__________________________"}
                      </td>
                    </tr>
                    <tr style={{ border: "none" }}>
                      <td colSpan={2} style={{ border: "none", padding: "20px 0 0 0", fontSize: "11pt", verticalAlign: "top", textAlign: "center" }}>
                        Mengetahui,<br />
                        Kepala Sekolah
                        <br /><br /><br /><br /><br />
                        <span style={{ textDecoration: "underline", fontWeight: "bold" }}>{inputs.namaKepsek || "__________________________"}</span><br />
                        NIP. {inputs.nipKepsek || "__________________________"}
                      </td>
                    </tr>
                  </tbody>
                </table>
